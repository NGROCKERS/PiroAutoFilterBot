...
# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300000))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))
# Bot images & videos
PICS = (environ.get('PICS', 'https://telegra.ph/file/5bcaf28f38266a13c9d63.jpg')).split()
...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", '📂 <em>File Name</em>: <code>MALLUROCKERS CLUB |{file_name}</code> \n\n🖇 <em>File Size</em>: <code>{file_size}</code> \n\n❤️‍🔥 </i>Join</i> [MALLUROCKERS CLUB 🎬](https://t.me/MALLUROCKERSCLUB)  \n\n🖥 <i>Requests</i> - ||@NGROCKER|| ')
