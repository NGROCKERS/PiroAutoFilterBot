...
async def start(client, message):
        ...
        for msg in msgs:
            ...
            try:
                await client.send_cached_media(
                    ...
                    reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚔️ MALLUROCKERS CLUB MOVIES AND SERIES ⚔️', url="https://t.me/+b5lfEUAJWEQ5ZmE0") ] ] ),
    ...
    await client.send_cached_media(
        ...
        caption=f_caption,
        protect_content=True if pre == 'filep' else False,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚔️ MALLUROCKERS CLUB ♥️ ⚔️', url="https://t.me/MALLUROCKERSCLUB") ] ] ),
    )
