...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
            ...
            if AUTH_CHANNEL and not await is_subscribed(client, query):
                ...
                if clicked == typed:
                    await client.send_cached_media(
                        ...
                        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚔️ MALLUROCKERS⚔️', url="https://t.me/MALLUROCKERSCLUB") ] ] ))
                else:
                    await query.answer(f"𝖧𝖾𝗒 {query.from_user.first_name}, 𝖳𝗁𝗂𝗌 𝗂𝗌 𝗇𝗈𝗍 𝗒𝗈𝗎𝗋 𝗋𝖾𝗊𝗎𝖾𝗌𝗍 !", show_alert=True)
        ...
        await client.send_cached_media(
            ...
            reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('⚔️ MALLUROCKERS UPDATES ⚔️', url="https://t.me/MALLUROCKERSCLUB") ] ] ))
        ...
        buttons = [[
            InlineKeyboardButton('🧬 𝖲𝗎𝗉𝗉𝗈𝗋𝗍 𝖦𝗋𝗈𝗎𝗉', url=f"https://t.me/{SUPPORT_CHAT}"),
            InlineKeyboardButton('📍 CHECK IN ', callback_data='source')
        ],[
            InlineKeyboardButton('🏘 𝖧𝗈𝗆𝖾', callback_data='start'),
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("📞 𝖢𝗈𝗇𝗍𝖺𝖼𝗍", url="t.me/ngrocker")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
